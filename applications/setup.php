...
class SetupApp extends application
{
    public function __construct()
    {
        ...
        $this->add_rapp_function(0, _('税率'), 'taxes/tax_types.php?', 'SA_TAX_TYPE', MENU_SETTINGS);
        $this->add_rapp_function(0, _('税率类型'), 'taxes/item_tax_types.php?', 'SA_ITEM_TAX_TYPE', MENU_SETTINGS);
        ...
        $this->add_lapp_function(1, _('年度账务'), 'admin/fiscalyears.php?', 'SA_FISCALYEARS', MENU_MAINTENANCE);
