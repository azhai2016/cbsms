 ...
 * qrcode class
 */
require_once(dirname(__FILE__)."/qrcodes.php");

require_once(dirname(__FILE__)."/tcpdf_barcode_2d.php");
	...
	*/
	 ...
	 */
		...
		*/
		...
		var $alpha = array('CA' => 1, 'ca' => 1, 'BM' => '/Normal', 'AIS' => false);

		var $check_page_regions = true;
		...
		*/
		function AddFont($family, $style='', $file='') {
			...
			$style = isset($style)?strtoupper($style):'';
			// underline
...
//			$this->_out('%PDF-'.$this->PDFVersion);
	...
	public function write2DBarcode($code, $type, $x=null, $y=null, $w=null, $h=null, $style=array(), $align='', $distort=false) {
		...
		// set dimensions
		if ((empty($w) OR ($w <= 0)) AND (empty($h) OR ($h <= 0))) {
